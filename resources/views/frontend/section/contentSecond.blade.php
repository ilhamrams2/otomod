<div class="col-lg-8 p5px">
    ...
    <div class="col-12 top-kat d-flex align-items-center pb-3">
        ...
        <h4 class="text-uppercase px-3 m-0">{{ $beritaKat4->kategori->kategori }}</h4>
        <div class="kategori-abu"></div>
    </div>

    @foreach ($beritas as $berita)

        @if ($berita->kategori->id == 4)
            @if ($countBerita < 2)
...
<div class="col-lg-4 ms-auto p5px">
    <div class="top-kat d-flex align-items-center pb-2">
        <div class="kategori-merah"></div>
        <h4 class="text-uppercase px-3 m-0">{{ $beritaKat1->kategori->kategori }}</h4>
        <div class="kategori-abu"></div>
    </div>
    @foreach ($beritas as $berita)
        @if ($berita->kategori->id == 1)
            @if ($countBerita < 10)
