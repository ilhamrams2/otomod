...
@section('content')
        ...
        <div class="col-lg-11 py-4 mx-auto">
            <div class="card p-4">
                <button type="button" class="btn btn-outline-info w-100 mb-3" data-toggle="modal"
                    ...
                    <i class="fas fa-plus-circle"></i> Buat User pengguna
                </button>
                    ...
                    <table id="example" class="table table-striped table-bordered bg-light mt-3 table-sm text-left"
                        ...
                        <tbody>
                            ...
                            @foreach ($allPengguna as $pengguna)
                                <tr>
                                    <td class="align-middle text-center">
                                        ...
                                        <img class="img-fluid bg-light img-rounded-circle"
                                            src="{{ asset('storage/img-profile/' . $pengguna->image) }}" alt=""
                                            style="object-fit: cover; object-position: center; width: 40px; height: 40px; border-radius: 50%;">
                                    </td>
                                    <td class="align-middle">{{ $pengguna->name }}</td>
                                    <td class="align-middle">{{ $pengguna->status->status_name }}</td>
                                ...
                                @include('backend.modals.pengguna.editPengguna')
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
    ...
    <div class="modal fade" id="modal-pengguna" tabindex="-1" role="dialog" aria-labelledby="label-pengguna"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal">
            <div class="modal-content">
                ...
                <div class="modal-header py-2">
                    <h5 class="modal-title">Buat User pengguna</h5>
